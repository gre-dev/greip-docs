...
sidebarTitle: "Customize Response"
...
```
https://greipapi.com/geoip?key=1234567890&params=device
```

And, if your need to retrieve multiple modules, you can add the parameter by separate the needed modules with a comma:

```
https://greipapi.com/geoip?key=1234567890&params=timezone,currency,security
```
