...
The Greip Fraud Prevention API can be used for both personal and commercial use cases, and you'll receive the same level of accuracy, speed, and security regardless of whether you have a paid plan or not. To get started, you'll need to [create account](https://greip.io/portal/register) and obtain a unique API key. Once you have your key, you can use it to access the API's functions and start detecting and preventing fraud in your website or app.
